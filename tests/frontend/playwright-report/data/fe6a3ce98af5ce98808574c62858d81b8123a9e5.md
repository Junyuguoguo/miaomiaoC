...
- Name: login.spec.ts >> 登录页面 >> 页面加载成功
- Location: login.spec.ts:10:7
...
Expected: visible
Error: strict mode violation: locator('h2, h1') resolved to 2 elements:
    1) <h1 data-v-8cadd2ac="">…</h1> aka getByRole('heading', { name: 'C语言在线考试平台' })
    2) <h2 data-v-8cadd2ac="">欢迎回来，开启高效学习之旅</h2> aka getByRole('heading', { name: '欢迎回来，开启高效学习之旅' })
