...
- Name: exam.spec.ts >> 考试结果页面 >> 显示考试成绩
- Location: exam.spec.ts:60:7
...
Locator: locator('.score, .grade, [class*="score"], [class*="grade"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.score, .grade, [class*="score"], [class*="grade"]')
