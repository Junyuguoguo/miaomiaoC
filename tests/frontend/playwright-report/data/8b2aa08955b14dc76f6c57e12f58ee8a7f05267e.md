...
- Name: exam.spec.ts >> 考试进行页面 >> 显示题目内容
- Location: exam.spec.ts:43:7
...
Locator: locator('.question, .question-item, [class*="question"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.question, .question-item, [class*="question"]')
