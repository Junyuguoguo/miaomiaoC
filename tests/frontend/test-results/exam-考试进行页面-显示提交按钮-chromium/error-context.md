...
- Name: exam.spec.ts >> 考试进行页面 >> 显示提交按钮
- Location: exam.spec.ts:48:7
...
Locator: locator('button:has-text("提交"), button:has-text("交卷")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("提交"), button:has-text("交卷")')
