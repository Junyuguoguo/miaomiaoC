...
- Name: exam.spec.ts >> 考试结果页面 >> 页面加载成功
- Location: exam.spec.ts:55:7
...
Locator: locator('.result-container, .result-content, [class*="result"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.result-container, .result-content, [class*="result"]')
