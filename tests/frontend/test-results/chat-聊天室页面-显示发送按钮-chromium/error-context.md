...
- Name: chat.spec.ts >> 聊天室页面 >> 显示发送按钮
- Location: chat.spec.ts:47:7
...
Locator: locator('button:has-text("发送"), button[type="submit"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("发送"), button[type="submit"]')
